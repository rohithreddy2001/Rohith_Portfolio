...
const projectsData = [
  {
    ...
    description: "Developed a Grocery Store Management System, enabling efficient product and order management. Integrated automatic UOM selection, reducing errors by auto-setting units (e.g., 'Kg' for 'Daal') across 100+ products. Streamlined order creation, handling 50+ orders with dynamic total calculations averaging $150 per order. Ensured seamless navigation across Dashboard, Product Management, and Order pages, cutting page transition time by 40%. Deployed on Vercel and Render, achieving 99.9% uptime. These features empower store managers to save 10+ hours weekly, boost order accuracy, and enhance operational efficiency.",
    links: {
  ...
  },
  {
    ...
    description: "Analyzed retail data, uncovering $10.67M in revenue from 6M units sold, with $9.85M generated on weekdays. Identified a 30.69% revenue surge in November and a 57.68% decline in December, highlighting key seasonal trends. Found top-performing customers and regions, with Customer 14646 contributing $280K, while the Netherlands ($285K) and Ireland ($283K) led in revenue. These insights help businesses optimize strategies, improve marketing efforts, and maximize sales performance.",
    links: {
  ...
  },
  {
    ...
    description: "Conducted a comprehensive analysis of city-level performance, focusing on trip volume, pricing efficiency, and passenger satisfaction. Identified seasonal patterns and demand variations between weekdays and weekends, while exploring repeat passenger behavior and loyalty trends. Delivered actionable insights to enhance monthly target achievements for trips and passenger ratings.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiYTllYzFmNGUtYTlhMS00MjVlLWFmNjUtZjJiMjdlZjMyMWMxIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9",
  ...
  },
  {
    ...
    description: "In a project for AtliQ Mart, I analyzed key supply chain metrics (OTD %, OTIF %, Line Fill Rate) and developed an interactive Power BI dashboard. By leveraging advanced bookmarks, slicers, and DAX formulas, I boosted navigation efficiency by 25% and improved report accuracy by 15%.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiNGZhZTBlZWItYjE1YS00YzIyLThjNGUtYTFkZjQ1MGI4OWY2IiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9",
  ...
  },
  {
    ...
    domain: "Automotive",
    skills: ["MySQL", "Power BI", "DAX"],
    description: "The focus was to uncover critical insights for an automotive company planning to launch EVs in India. These insights offer a data-driven foundation for launching and scaling EVs in India, helping to navigate this dynamic and fast-evolving market.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiNmJjNDQzYTYtZGQ0NC00YzFhLWI2ZjAtNDZhNzNiOGY3MmRlIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9",
  ...
  },
  {
    ...
    domain: "Sports",
    skills: ["MySQL", "Power BI", "DAX"],
    description: "The analysis explored critical cricket statistics, including aggregate runs, batting averages, bowler’s economy rates, and the percentage of dot balls. Additionally, it examined team performances over the years, providing valuable insights for both fans and experts.",
    links: {
      live_link: "https://app.powerbi.com/view?r=eyJrIjoiMmZjMDVmNDgtN2ZmMS00MTk2LTgyZWMtNWE1ZDI0OGVlOTY2IiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M2VkN2ZmOTVhMCJ9&pageName=ReportSection8f5075557b9747d605d6",
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiMmZjMDVmNDgtN2ZmMS00MTk2LTgyZWMtNWE1ZDI0OGVlOTY2IiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9&pageName=ReportSection8f5075557b9747d605d6",
  ...
  },
  {
    ...
    domain: "Tourism",
    skills: ["Excel", "Power BI", "DAX"],
    description: "The Telangana Tourism Dashboard offers a detailed snapshot of the region’s tourism, spotlighting Hyderabad, and ranks districts by growth rates. It also forecasts tourist counts and industry earnings.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiZWUzNmI2MjMtNTM1My00MmJkLThmMzgtNTYzMDM1ZWFhYTdiIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9&pageName=05aeff519c9307c8bc26",
  ...
  },
  {
    ...
    description: "Utilizing data from the T20 World Cup 2022, my goal was to pinpoint the standout Batters, Bowlers, and All-Rounders, considering a range of performance categories.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiMTNmMDE3M2YtMzM2OC00ZjkwLWIwNjMtNThhMmIwNWE5MjdiIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9&pageName=ReportSection",
  ...
  },
  {
    ...
    domain: "Banking",
    skills: ["MySQL", "Power BI", "DAX"],
    description: "Create an all-encompassing weekly dashboard for credit cards, offering real-time visibility into critical performance metrics and trends. This will empower stakeholders to effectively monitor and analyze credit card operations.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiZDJhYzJmZTctNmQ2MS00NThjLTg1NDMtMzQ5YWZhYjQ3NjlkIiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9&pageName=ReportSection36d300139988ed03a040",
  ...
  },
  {
    ...
    description: "In this HR Analytics project, I analyzed employee attrition using Python and MySQL on a Kaggle dataset. Key insights showed higher attrition among non-trained employees (53.82%) and the Executive Office (66.67%). The project explored department-wise trends, hiring patterns, and work-life balance, aiding HR in data-driven retention strategies.",
    links: {
  ...
  },
  {
    ...
    description: "The 2023 Call Center Report reveals $96,623 from 1,000 calls over 1,498 minutes, with an average rating of 3.89 and 307 five-star ratings. Rep R03 earned $20.9k. Peak times were April and October, busiest on Wednesdays. Cleveland had the most male callers. Ratings were mostly 4 and 5 stars, crucial for boosting efficiency and satisfaction.",
    links: {
  ...
  },
  {
    ...
    description: "An Excel dashboard was created for the Women's Premier League (WPL) 2024, showcasing top performances with the bat and ball. The dashboard features an interactive filter, allowing users to view stats for specific teams, making it easy to analyze and compare player performances across the league.",
    links: {
  ...
  },
  {
    ...
    domain: "Hospitality",
    skills: ["Excel", "Power BI", "DAX"],
    description: "I analyzed historical data to offer revenue insights to the AtliQ Grand hotel team, with the goal of improving revenue and market share relative to other hotels.",
    links: {
      ...
      power_bi: "https://app.powerbi.com/view?r=eyJrIjoiYzRlNjZlMTQtNzc3NS00Yzc2LTg3MzItOWM4ODViNmIwMTE0IiwidCI6ImRmODY3OWNkLWE4MGUtNDVkOC05OWFjLWM4M3VkN2ZmOTVhMCJ9&pageName=ReportSection",
  ...
  },
  {
    ...
    description: "This project aims to provide people with insights into the COVID-19 situation in their country, allowing them to identify areas where the virus is spreading rapidly and enabling informed planning.",
    links: {
